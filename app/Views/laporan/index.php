    ...
    <div class="card mb-4">
        <div class="card-header">
            <div class="text-center">
                <i class="bi bi-table"></i> Laporan Data Keuangan Masjid
            </div>
        </div>
                ...
                <tbody>
                    ...
                    <?php foreach ($laporan as $l) : ?>
                        <tr>
                            ...
                            <td>
                                <button class="btn btn-primary toggle-detail" data-toggle="modal" data-target="#rincianPemasukan<?= $i ?>"><i class="bi bi-box-arrow-up-right"></i> Lihat Rincian Pemasukan</button>
                            </td>
                            <td>
                                <button class="btn btn-primary toggle-detail" data-toggle="modal" data-target="#rincianPengeluaran<?= $i ?>"><i class="bi bi-box-arrow-up-right"></i> Lihat Rincian Pengeluaran</button>
                            </td>
                        </tr>
